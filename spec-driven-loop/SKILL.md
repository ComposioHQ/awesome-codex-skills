...
description: Run a specification-first workflow for uncertain medium-to-large software development by clarifying product and technical decisions, freezing acceptance criteria, coordinating agents with explicit ownership, and independently judging delivery. Use for new products, substantial features, or cross-module changes; not for small edits, reviews, diagnosis, or pure research.
---
