...
- [code-review-gate](https://github.com/skyestrela/ai-agent-skill-preview/tree/main/code-review-gate) - Run an evidence-first pre-merge review for security, correctness, and maintainability findings, with file-level severity and a ship/no-ship verdict. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo skyestrela/ai-agent-skill-preview --path code-review-gate --name code-review-gate`
