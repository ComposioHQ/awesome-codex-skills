...
- [accelerate-local-work](https://github.com/cloudguo123/mac-parallel-accelerator/tree/main/skills/accelerate-local-work) - AtomLane skill that compiles and executes only proven-safe atomic parallel plans for macOS shell, package, Make, Compose, build, test, and benchmark workflows, with live progress and measured savings. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo cloudguo123/mac-parallel-accelerator --path skills/accelerate-local-work --name accelerate-local-work`
