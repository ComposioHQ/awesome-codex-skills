...
- [CTO Skill](https://github.com/Bliveren/CTO-skill) - AI-native CTO bundle for repository-backed roadmaps, evidence-driven branch/PR review, risk-tiered autonomy, governed default merges, release gates, and multi-agent delivery. Includes `cto`, `cto-planner`, and `cto-reviewer` with English and Chinese docs.
