...
- [codex-readiness-auditor](https://github.com/grnbtqdbyx-create/trace-to-skill/tree/main/skills/codex-readiness-auditor) - Audit an OSS repository before Codex automation with deterministic scorecards, AGENTS.md rule evidence, PR comment reports, and prompt-injection checks. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo grnbtqdbyx-create/trace-to-skill --path skills/codex-readiness-auditor --name codex-readiness-auditor`
