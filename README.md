...
- [agenttrace-session-audit](https://github.com/luoyuctl/agenttrace/blob/master/skills/agenttrace-session-audit/SKILL.md) - Audit local AI coding-agent sessions for cost, latency, failures, anomalies, health, and diffs. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo luoyuctl/agenttrace --path skills/agenttrace-session-audit --name agenttrace-session-audit`
