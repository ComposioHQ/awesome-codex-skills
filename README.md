...
- [clize/](./clize/) - Give Codex real-world hands: buy or import a domain, run a real send-and-receive inbox (sign up for services, read the verification code out of it), deploy a static site, take Stripe payments, generate images/video/music. Money, outbound identity and untrusted inbound each sit behind a gate, and you hold no provider API keys.
