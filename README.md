...
- [linkedin-skills](https://github.com/sergebulaev/linkedin-skills) - External repo: 10 MIT-licensed LinkedIn skills with native Codex support (`.codex-plugin` manifest and a Codex marketplace package). Post writing with 16 tested hook formulas, AI-tell scrubbing, pre-publish audits, comment and reply drafting, hook extraction, content planning, profile optimization, engagement analytics, and thread monitoring. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo sergebulaev/linkedin-skills --path skills/linkedin-post-writer --name linkedin-post-writer`
