...
- [gemini-web-mcp/](./gemini-web-mcp/) - Use and maintain Gemini Web MCP safely: manifest-first tool selection, narrow `GEMINI_TOOLS` profiles, chat history, native notebooks, account inventory, scheduled actions, and media verification.
