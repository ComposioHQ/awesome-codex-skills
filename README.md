...
- [github-income-scout](https://github.com/George4177/github-income-scout/tree/main/codex-skills/github-income-scout) - Screen GitHub issues for low-risk Python, automation, CI, and documentation work; reject unsafe, claimed, duplicate, or unfunded tasks; and package Starter Audit or PR action reports. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo George4177/github-income-scout --path codex-skills/github-income-scout --name github-income-scout`
