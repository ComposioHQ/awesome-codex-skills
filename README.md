...
- [chrome-ask-gemini-launcher](https://github.com/barry166/chrome-ask-gemini-launcher) - Create a macOS Chrome launcher that starts Google Chrome with Ask Gemini feature flags, adds a distinct Dock app, and preserves vertical tabs without patching Google Chrome.app. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo barry166/chrome-ask-gemini-launcher --path skills/chrome-ask-gemini-launcher --name chrome-ask-gemini-launcher`
