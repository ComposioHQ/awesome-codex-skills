...
- [animate-roblox-characters](https://github.com/dillydog580/animate-roblox-characters) - Create, audit, export, and preview complete stylized Roblox R6/R15 character animations through Blender MCP using authentic Studio-derived rigs. Install: `npx skills add dillydog580/animate-roblox-characters`
