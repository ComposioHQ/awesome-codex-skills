...
- [spec-driven-loop/](./spec-driven-loop/) - Freeze PRD, technical design, and acceptance criteria before coordinating parallel agents; the lead agent independently judges completion from diffs, tests, and evidence.
