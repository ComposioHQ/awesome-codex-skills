...
- [UIZZE anti-ui-slop](https://github.com/uizze/uizze/tree/main/skills/anti-ui-slop) - Use 800,000+ real web and iOS screens to ground product-specific UI decisions, define a design contract, cover required states, and run a hard finish gate before shipping. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo uizze/uizze --path skills/anti-ui-slop --name anti-ui-slop`
