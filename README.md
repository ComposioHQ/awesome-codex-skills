...
- [verify-document/](./verify-document/) - Forensic document authenticity: tamper risk band + per-signal evidence for payslips, invoices, bank statements, IDs via the Stipple API (free tier). Catches tampered documents before extraction or onboarding workflows trust them.
