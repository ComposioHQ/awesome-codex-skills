...
- [codex-profile-switching/](./codex-profile-switching/) - Set up, inspect, switch, and troubleshoot Codex CLI/Desktop profiles with isolated `CODEX_HOME` directories.
