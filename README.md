...
- [checkyourself](https://github.com/KyaniteLabs/checkyourself/tree/main/skills/checkyourself) - Production-readiness diagnostics and guided remediation for AI-built apps: read-only audits, 0-100 reality scores, evidence-backed findings, safe fix batches, and learning plans. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo KyaniteLabs/checkyourself --path skills/checkyourself --name checkyourself`
