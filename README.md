...
- [tree-ring-memory/](./tree-ring-memory/) - Local-first memory lifecycle guidance for Codex agents: project-scoped recall, explicit writes, evidence records, audit, forgetting, and source-linked DOX/Revolve sync without transcript dumping.
