...
- [UIZZE: Stop AI UI Slop](https://github.com/aislon/uizze-mcp/tree/main/skills/uizze-ui-research) - Stop Codex from shipping generic AI UI: ground the task in real web or iOS interfaces, lock product-specific constraints, then validate, audit, and critique the result. Paid UIZZE access and an agent token are required. Install: `npx skills add aislon/uizze-mcp --skill uizze-ui-research`. [Connect UIZZE](https://uizze.com).
