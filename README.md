...
- [uizze-ui-research](https://github.com/aislon/uizze-mcp/tree/main/skills/uizze-ui-research) - Guide Codex through real web or iOS reference research, design constraints, implementation validation, deterministic audits, and rendered-UI critique through UIZZE MCP. Hosted workflows require full access and a bearer token. Install: `npx skills add aislon/uizze-mcp --skill uizze-ui-research`. [Connect UIZZE](https://uizze.com/?view=agent&utm_source=awesome-codex-skills&utm_medium=directory&utm_campaign=github-awesome-codex-skills-uizze-research&utm_content=development-tools-entry).
