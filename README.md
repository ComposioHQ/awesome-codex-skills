...
- [clerk-skills](https://clerk.com/docs/guides/ai/skills) - Add Clerk auth from Codex: project setup, custom sign-in UI, and CLI operations. `npx skills add clerk/skills`
