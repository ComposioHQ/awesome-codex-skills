...
- [UIZZE anti-ui-slop Skill](https://github.com/uizze/uizze/tree/main/skills/anti-ui-slop) - Free MIT Codex Skill for product-specific UI decisions, design contracts, required UI states, anti-slop review, and a hard finish gate. Optional [UIZZE](https://uizze.com/) workflow researches 800,000+ real web and iOS screens. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo uizze/uizze --path skills/anti-ui-slop --name anti-ui-slop`
