...
### Development & Code Tools\n\n- [accelerate-local-work](https://github.com/cloudguo123/mac-parallel-accelerator/tree/main/skills/accelerate-local-work) - Compile and execute safe resource-aware atomic parallel plans for macOS shell, package, Make, Compose, build, test, and benchmark workflows, with live progress and measured time savings. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo cloudguo123/mac-parallel-accelerator --path skills/accelerate-local-work --name accelerate-local-work`
