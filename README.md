...
- [handoff-ds](https://github.com/dazuiba/handoff) - Delegate tasks to DeepSeek V4 without leaving your Codex session. Install: `uv tool install handoff-cli && handoff init`
