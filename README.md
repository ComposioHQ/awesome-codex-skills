...
- [agent-qa-authoring](https://github.com/vostride/agent-qa/tree/main/skills/agent-qa-authoring) - Author natural-language web and mobile QA tests. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo vostride/agent-qa --path skills/agent-qa-authoring --name agent-qa-authoring`
- [agent-qa-debug-fix](https://github.com/vostride/agent-qa/tree/main/skills/agent-qa-debug-fix) - Debug failed agent-qa runs and propose fixes. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo vostride/agent-qa --path skills/agent-qa-debug-fix --name agent-qa-debug-fix`
- [agent-qa-result-triage](https://github.com/vostride/agent-qa/tree/main/skills/agent-qa-result-triage) - Triage agent-qa results by failure category. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo vostride/agent-qa --path skills/agent-qa-result-triage --name agent-qa-result-triage`
