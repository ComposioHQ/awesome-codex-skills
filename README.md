...
- [BrowserAct Skills](https://github.com/browser-act/skills) - Reusable browser automation skill collection for Codex, including BrowserAct CLI guidance, Skill Forge, and ready-to-use workflows for research, extraction, and repeatable web tasks. Install: `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo browser-act/skills --path browser-act --name browser-act`
